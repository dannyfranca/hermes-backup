...
Runs the offline bootstrap/config/staging/backup/restore/promote verification harness:
  ...
  3. Pytest coverage for preflight, config writer, install skeleton, inventory, SQLite-safe staging, restic backup/retention, restic check, safe restore, explicit promote, repo safety, and harness contracts.
