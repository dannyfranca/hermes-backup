...
Runs the offline bootstrap/config/staging/backup/restore verification harness:
  ...
  3. Pytest coverage for preflight, config writer, install skeleton, inventory, SQLite-safe staging, restic backup/retention, safe restore, repo safety, and harness contracts.
