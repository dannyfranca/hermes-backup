...
Runs the offline bootstrap/config verification harness:
  ...
  3. Pytest coverage for preflight, config writer, install skeleton, repo safety, and harness contracts.
