...
HERMES_BACKUP_LOG_DIR=$(shell_escape_single "$HOME/.local/state/hermes-backup/logs")
HERMES_BACKUP_STAGING_DIR=$(shell_escape_single "$HOME/.local/state/hermes-backup/staging")
